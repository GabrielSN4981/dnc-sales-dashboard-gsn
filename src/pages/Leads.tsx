...
function Leads() {
  ...
  useEffect(() => {
    if (createLeadsData?.id) {
      ...
      setCreateMessage({
        msg: "Não foi possível deletar o perfil. Entre em contato com o suporte.",
        type: "error",
      });
    } else {
      clearMessage();
    ...
    <>
      ...
      <Container className="mb-2" maxWidth="lg">
        <Grid container spacing={4}>
          <Grid className="mb-1" /* item xs={12} sm={5} */ size={7}>
            <CardComponent
              className={
          ...
          <Grid className="mb-1" /* item xs={12} sm={7} */ size={5}>
            <CardComponent>
